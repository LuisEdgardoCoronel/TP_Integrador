...
namespace TP_Integrador
{
    internal class MapaAereo : Mapa
    {
        ...
        private int[] dx { get; set; } = { -1, 0, 1, 0 };
        ...
        private int[] dy { get; set; } = { 0, -1, 0, 1 };
        ...
        [JsonConstructor]
        public MapaAereo(List<Nodo> terrenos, int n, List<Cuartel> cuarteles, List<SitioReciclaje> sReciclaje, List<Localizacion> vertederos,
